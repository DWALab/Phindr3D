...
* To install the stand-alone program, download the executable *Phindr3D.exe* from the [**Releases**](Phindr3D/releases) in the Github repository. This executable includes *Phindr3D* and the Organoid Contour Segmentation app. 
